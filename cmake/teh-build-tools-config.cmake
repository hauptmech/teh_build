...
macro (teh_add_to_config LIBNAME)
	if (TARGET ${LIBNAME})
		message("Adding library: ${LIBNAME}")
		LIST(APPEND TEH_MY_LIBRARIES ${LIBNAME})
	endif()
	...
	message("Adding include files dependency: ${LIBNAME} ${${LIBNAME}_LIBRARIES}")
